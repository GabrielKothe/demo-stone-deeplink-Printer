...
type
  ...
  public
    ...
    function SetAuthorizationCode(const AAuthorizationCode: string): IStoneDeeplinkPaymentReturnEntityBuilder;
...
function TStoneDeeplinkPaymentReturnEntityBuilder.SetAuthorizationCode(const AAuthorizationCode: string): IStoneDeeplinkPaymentReturnEntityBuilder;
begin
  Result := Self;
