...
function TStoneDeeplinkPaymentReturnAndroidAdapter.GetATK(AATK: string): string;
begin
...
begin
  LPaymentReturnEntityBuilder := TStoneDeeplinkPaymentReturnEntityBuilder.New
    ...
    .SetAuthorizationCode(JStringToString(FIntent.getData.getQueryParameter(StringToJString('authorization_code'))))
