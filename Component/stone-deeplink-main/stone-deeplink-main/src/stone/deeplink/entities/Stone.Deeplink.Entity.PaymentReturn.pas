...
type
  ...
  public
    ...
    procedure SetAuthorizationCode(const AAuthorizationCode: string);
...
function TStoneDeeplinkPaymentReturnEntity.GetAuthorizationCode: string;
begin
...
procedure TStoneDeeplinkPaymentReturnEntity.SetAuthorizationCode(const AAuthorizationCode: string);
begin
